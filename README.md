...
`sudo apt install build-essential gcc make perl libssl-dev meson ninja-build clang flex bison libgmp3-dev libmpc-dev libmpfr-dev texinfo python3-pip qemu-system-x86 help2man autopoint gperf nasm llvm mercurial && pip3 install xbstrap && pip3 install mako`
